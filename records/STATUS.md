...
- Current focus: release 0.1.7 and physical Switch validation of lossless video merging, audio playback, large-selection batching, progressive startup, bot onboarding, cached chat UX, and transfer progress
...
- Goal: validate progressive thumbnail loading, bot onboarding, playback audio/pause/resume, lossless merged-video delivery, large-selection transfer progress, cached chat opening, and the update action on hardware.
